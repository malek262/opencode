export const dict = {
  ...
  "sidebar.archived": "آرکائیو شدہ",
  "sidebar.archived.restore": "سیشن بحال کریں",
  ...
  "settings.general.row.sidebarSessions.title": "غیر فعال سیشن آرکائیو کریں",
  "settings.general.row.sidebarSessions.description": "غیر فعال سیشن آرکائیو شدہ میں منتقل ہو جاتے ہیں۔ فعال سیشن نظر آتے رہتے ہیں۔",
