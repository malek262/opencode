export const dict = {
  ...
  "sidebar.settled": "Classés",
  "sidebar.settle": "Classer le fil",
  "sidebar.unsettle": "Rétablir le fil",
  "sidebar.thread.new": "Nouveau fil",
  "sidebar.thread.pin": "Épingler le fil",
  ...
  "settings.general.row.navigation.description": "Utiliser des onglets dans la barre de titre ou une barre latérale permanente",
  "settings.general.row.navigation.tabs": "Onglets",
  "settings.general.row.navigation.sidebar": "Barre latérale",
  "settings.general.row.sidebarSessions.title": "Classer les fils inactifs après",
  "settings.general.row.sidebarSessions.description": "Les fils inactifs sont classés. Les fils en cours restent visibles.",
  "settings.general.row.sidebarSessions.always": "Toujours afficher",
