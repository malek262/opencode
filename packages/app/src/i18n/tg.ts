export const dict = {
  ...
  "sidebar.archived": "Арxivшуда",
  "sidebar.archived.restore": "Барқарор кардани сеанс",
  ...
  "settings.general.row.sidebarSessions.title": "Сеансҳои беҳаракатро архив кардан",
  "settings.general.row.sidebarSessions.description": "Сеансҳои беҳаракат ба Арxivшуда мегузаранд. Сеансҳои фаъол намоён мемонанд.",
