export const dict = {
  ...
  "sidebar.archived": "Arhiwlenen",
  "sidebar.archived.restore": "Sessiýany dikelt",
  ...
  "settings.general.row.sidebarSessions.title": "Işjeň däl sessiýalary arhiwle",
  "settings.general.row.sidebarSessions.description": "Işjeň däl sessiýalar Arhiwlenen bölümine geçýär. Işleýän sessiýalar görünýär.",
