export const dict = {
  ...
  "sidebar.settled": "Odłożone",
  "sidebar.settle": "Odłóż wątek",
  "sidebar.unsettle": "Przywróć wątek",
  "sidebar.thread.new": "Nowy wątek",
  "sidebar.thread.pin": "Przypnij wątek",
  "sidebar.thread.unpin": "Odepnij wątek",
  "sidebar.status.working": "W trakcie",
  "sidebar.status.done": "Gotowe",
  "sidebar.status.attention": "Wymaga danych",
  ...
  "settings.general.row.navigation.description": "Używaj kart na pasku tytułu lub stałego paska bocznego",
  "settings.general.row.navigation.tabs": "Karty",
  "settings.general.row.navigation.sidebar": "Pasek boczny",
  "settings.general.row.sidebarSessions.title": "Odkładaj nieaktywne wątki po",
  "settings.general.row.sidebarSessions.description": "Nieaktywne wątki trafiają do odłożonych. Aktywne wątki pozostają widoczne.",
  "settings.general.row.sidebarSessions.always": "Zawsze pokazuj",
