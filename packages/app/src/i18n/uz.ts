export const dict = {
  ...
  "sidebar.archived.restore": "Sessiyani tiklash",
  ...
  "settings.general.row.sidebarSessions.title": "Harakatsiz sessiyalarni arxivlash",
  "settings.general.row.sidebarSessions.description": "Harakatsiz sessiyalar Arxivlangan bo'limiga o'tadi. Faol sessiyalar ko'rinib qoladi.",
