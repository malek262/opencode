...
export const dict = {
  ...
  "sidebar.navigation.filter": "Filter projects and sessions",
  "sidebar.navigation.noMatches": "No matching sessions",
  "sidebar.navigation.projects": "Projects",
  "sidebar.navigation.settle": "Settle session",
  "sidebar.navigation.settled": "Settled",
  "sidebar.navigation.settled.show": "Show settled sessions",
  "sidebar.navigation.settled.empty": "No settled sessions",
  "sidebar.navigation.settled.restore": "Restore session",
  ...
  "settings.general.row.navigation.title": "Navigation",
  "settings.general.row.navigation.description": "Switch between session tabs in the title bar and a persistent sidebar",
  "settings.general.row.navigation.tabs": "Tabs",
  "settings.general.row.navigation.sidebar": "Sidebar",
  "settings.general.row.sidebarSessions.title": "Settle sessions after",
  "settings.general.row.sidebarSessions.description":
    "Sessions idle for longer than this are hidden under Settled in the sidebar. Working and open sessions always stay visible.",
  "settings.general.row.sidebarSessions.always": "Always show",
  "settings.general.row.sidebarSessions.days.one": "{{count}} day",
  "settings.general.row.sidebarSessions.days.other": "{{count}} days",
