...
export const dict = {
  ...
  "sidebar.settled": "已搁置",
  "sidebar.settle": "搁置话题",
  "sidebar.unsettle": "恢复话题",
  "sidebar.thread.new": "新建话题",
  "sidebar.thread.pin": "固定话题",
  "sidebar.thread.unpin": "取消固定",
  "sidebar.status.working": "工作中",
  "sidebar.status.done": "已完成",
  "sidebar.status.attention": "需要输入",
  ...
  "settings.general.row.sidebarSessions.title": "闲置话题搁置时间",
  "settings.general.row.sidebarSessions.description": "闲置话题会移入已搁置。工作中的话题保持显示。",
