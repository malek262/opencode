...
export const dict = {
  ...
  "sidebar.settled": "Abgelegt",
  "sidebar.settle": "Thread ablegen",
  "sidebar.unsettle": "Thread wiederherstellen",
  "sidebar.thread.new": "Neuer Thread",
  "sidebar.thread.pin": "Thread anheften",
  ...
  "settings.general.row.navigation.description": "Tabs in der Titelleiste oder eine dauerhafte Seitenleiste verwenden",
  "settings.general.row.navigation.tabs": "Tabs",
  "settings.general.row.navigation.sidebar": "Seitenleiste",
  "settings.general.row.sidebarSessions.title": "Inaktive Threads ablegen nach",
  "settings.general.row.sidebarSessions.description": "Inaktive Threads werden abgelegt. Aktive Threads bleiben sichtbar.",
  "settings.general.row.sidebarSessions.always": "Immer anzeigen",
