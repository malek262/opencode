export const dict = {
  ...
  "sidebar.settled": "Të mbyllura",
  "sidebar.settle": "Mbyll rrjedhën",
  "sidebar.unsettle": "Rihap rrjedhën",
  "sidebar.thread.new": "Rrjedhë e re",
  "sidebar.thread.pin": "Kapëse rrjedhën",
  ...
  "settings.general.row.navigation.description": "Përdor skeda në shiritin e titullit ose një shirit anësor të përhershëm",
  "settings.general.row.navigation.tabs": "Skeda",
  "settings.general.row.navigation.sidebar": "Shiriti anësor",
  "settings.general.row.sidebarSessions.title": "Mbyll rrjedhat joaktive pas",
  "settings.general.row.sidebarSessions.description": "Rrjedhat joaktive kalojnë te të mbyllurat. Rrjedhat aktive mbeten të dukshme.",
  "settings.general.row.sidebarSessions.always": "Shfaq gjithmonë",
