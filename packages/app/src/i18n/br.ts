export const dict = {
  ...
  "sidebar.settled": "Reoliet",
  "sidebar.settle": "Reoliañ an neudenn",
  "sidebar.unsettle": "Adkrouiñ an neudenn",
  "sidebar.thread.new": "Neudenn nevez",
  "sidebar.thread.pin": "Spilhennañ an neudenn",
  ...
  "settings.general.row.navigation.description": "Implijit abadennoù er varenn ditl pe ur varrenn gostez padus",
  "settings.general.row.navigation.tabs": "Abadennoù",
  "settings.general.row.navigation.sidebar": "Barrenn gostez",
  "settings.general.row.sidebarSessions.title": "Reoliañ an neudennoù diober goude",
  "settings.general.row.sidebarSessions.description": "An neudennoù diober a ya d'ar reoliet. An neudennoù o labourat a chom gwelus.",
  "settings.general.row.sidebarSessions.always": "Diskouez bepred",
