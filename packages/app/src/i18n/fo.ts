export const dict = {
  ...
  "sidebar.archived": "Arkiverað",
  "sidebar.archived.restore": "Endurstovna setan",
  ...
  "settings.general.row.sidebarSessions.title": "Arkiverað óvirknar setanir eftir",
  "settings.general.row.sidebarSessions.description": "Óvirknar setanir fara í Arkiverað. Virknar setanir síggjast framhaldandi.",
