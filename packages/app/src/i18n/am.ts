export const dict = {
  ...
  "sidebar.archived": "በማህደር የተቀመጠ",
  "sidebar.archived.restore": "ክፍለ ጊዜን መልስ",
  ...
  "settings.general.row.sidebarSessions.title": "የማይሰሩ ክፍለ ጊዜያትን አስቀምጥ",
  "settings.general.row.sidebarSessions.description": "የማይሰሩ ክፍለ ጊዜያት ወደ በማህደር የተቀመጠ ይሄዳሉ። እየሰሩ ያሉ ክፍለ ጊዜያት ይታያሉ።",
