...
export const dict = {
  ...
  "sidebar.settle": "Settle thread",
  "sidebar.unsettle": "Unsettle thread",
  "sidebar.thread.new": "New thread",
  "sidebar.thread.pin": "Pin thread",
  ...
  "settings.general.row.navigation.description": "Use title bar tabs or a persistent sidebar",
  "settings.general.row.navigation.tabs": "Tabs",
  "settings.general.row.navigation.sidebar": "Sidebar",
  "settings.general.row.sidebarSessions.title": "Settle idle sessions after",
  "settings.general.row.sidebarSessions.description": "Idle sessions move to Settled. Working sessions stay visible.",
