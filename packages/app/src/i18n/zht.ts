...
export const dict = {
  ...
  "sidebar.settled": "已擱置",
  "sidebar.settle": "擱置話題",
  "sidebar.unsettle": "還原話題",
  "sidebar.thread.new": "新增話題",
  "sidebar.thread.pin": "釘選話題",
  ...
  "settings.general.row.sidebarSessions.title": "閒置話題擱置時間",
  "settings.general.row.sidebarSessions.description": "閒置話題會移入已擱置。工作中的話題保持顯示。",
