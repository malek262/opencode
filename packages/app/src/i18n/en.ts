...
export const dict = {
  ...
  "sidebar.archived.restore": "Restore session",
  ...
  "settings.general.row.sidebarSessions.title": "Archive idle sessions after",
  "settings.general.row.sidebarSessions.description": "Idle sessions move to Archived. Working sessions stay visible.",
