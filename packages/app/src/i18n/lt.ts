...
export const dict = {
  ...
  "sidebar.archived": "Archyvuota",
  "sidebar.archived.restore": "Atkurti seansą",
  ...
  "settings.general.row.sidebarSessions.title": "Archyvuoti neveiklius seansus po",
  "settings.general.row.sidebarSessions.description": "Neveiklūs seansai perkeliami į Archyvuota. Aktyvūs seansai lieka matomi.",
