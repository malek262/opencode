export const dict = {
  ...
  "settings.general.row.sidebarSessions.title": "유휴 스레드 정리 기준 시간",
  "settings.general.row.sidebarSessions.description": "유휴 스레드는 정리됨으로 이동합니다. 작업 중인 스레드는 계속 표시됩니다.",
  ...
  "sidebar.settled": "정리됨",
  "sidebar.settle": "스레드 정리",
  "sidebar.unsettle": "스레드 복원",
  "sidebar.thread.new": "새 스레드",
  "sidebar.thread.pin": "스레드 고정",
