export const dict = {
  ...
  "sidebar.archived": "დაარქივებული",
  "sidebar.archived.restore": "სესიის აღდგენა",
  ...
  "settings.general.row.sidebarSessions.title": "უქმი სესიების დაარქივება",
  "settings.general.row.sidebarSessions.description": "უქმი სესიები გადაინაცვლებს დაარქივებულში. მოქმედი სესიები რჩება ხილული.",
