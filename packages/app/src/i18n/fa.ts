export const dict = {
  ...
  "sidebar.archived": "آرشیوشده",
  "sidebar.archived.restore": "بازیابی جلسه",
  ...
  "settings.general.row.sidebarSessions.title": "آرشیو کردن جلسات بیکار پس از",
  "settings.general.row.sidebarSessions.description": "جلسات بیکار به آرشیوشده منتقل می‌شوند. جلسات در حال کار نمایان می‌مانند.",
