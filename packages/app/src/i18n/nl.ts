export const dict = {
  ...
  "sidebar.archived.restore": "Sessie herstellen",
  ...
  "settings.general.row.sidebarSessions.title": "Inactieve sessies archiveren na",
  "settings.general.row.sidebarSessions.description": "Inactieve sessies gaan naar Gearchiveerd. Actieve sessies blijven zichtbaar.",
