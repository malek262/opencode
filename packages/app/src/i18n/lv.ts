export const dict = {
  ...
  "sidebar.archived": "Arhivētas",
  "sidebar.archived.restore": "Atjaunot sesiju",
  ...
  "settings.general.row.sidebarSessions.title": "Arhivēt neaktīvas sesijas pēc",
  "settings.general.row.sidebarSessions.description": "Neaktīvas sesijas tiek pārvietotas uz Arhivētas. Aktīvas sesijas paliek redzamas.",
