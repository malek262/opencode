export const dict = {
  ...
  "sidebar.settled": "سامان‌یافته",
  "sidebar.settle": "سامان دادن رشته",
  "sidebar.unsettle": "بازگرداندن رشته",
  "sidebar.thread.new": "رشته جدید",
  "sidebar.thread.pin": "سنجاق کردن رشته",
  ...
  "settings.general.row.navigation.description": "از برگه‌های نوار عنوان یا نوار کناری ثابت استفاده کنید",
  "settings.general.row.navigation.tabs": "برگه‌ها",
  "settings.general.row.navigation.sidebar": "نوار کناری",
  "settings.general.row.sidebarSessions.title": "سامان دادن رشته‌های غیرفعال پس از",
  "settings.general.row.sidebarSessions.description": "رشته‌های غیرفعال به سامان‌یافته می‌روند. رشته‌های در حال کار نمایان می‌مانند.",
  "settings.general.row.sidebarSessions.always": "همیشه نمایش بده",
