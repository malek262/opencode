...
export const dict = {
  ...
  "sidebar.settled": "Sutvarkytos",
  "sidebar.settle": "Sutvarkyti giją",
  "sidebar.unsettle": "Atkurti giją",
  "sidebar.thread.new": "Nauja gija",
  "sidebar.thread.pin": "Prisegti giją",
  ...
  "settings.general.row.navigation.description": "Naudoti skirtukus pavadinimo juostoje arba nuolatinę šoninę juostą",
  "settings.general.row.navigation.tabs": "Skirtukai",
  "settings.general.row.navigation.sidebar": "Šoninė juosta",
  "settings.general.row.sidebarSessions.title": "Sutvarkyti neveiklias gijas po",
  "settings.general.row.sidebarSessions.description": "Neveiklios gijos perkeliamos į sutvarkytas. Veikiančios gijos lieka matomos.",
  "settings.general.row.sidebarSessions.always": "Visada rodyti",
