export const dict = {
  ...
  "sidebar.archived": "Arxivades",
  "sidebar.archived.restore": "Restaura la sessió",
  ...
  "settings.general.row.sidebarSessions.title": "Arxiva les sessions inactives després de",
  "settings.general.row.sidebarSessions.description": "Les sessions inactives van a Arxivades. Les sessions actives continuen visibles.",
