export const dict = {
  ...
  "sidebar.settled": "Paigutatud",
  "sidebar.settle": "Paiguta lõim",
  "sidebar.unsettle": "Taasta lõim",
  "sidebar.thread.new": "Uus lõim",
  "sidebar.thread.pin": "Kinnita lõim",
  ...
  "settings.general.row.navigation.description": "Kasuta tiitliriba vahekaarte või püsivat külgriba",
  "settings.general.row.navigation.tabs": "Vahekaardid",
  "settings.general.row.navigation.sidebar": "Külgriba",
  "settings.general.row.sidebarSessions.title": "Paiguta jõude lõimed pärast",
  "settings.general.row.sidebarSessions.description": "Jõude lõimed liiguvad paigutatute hulka. Töötavad lõimed jäävad nähtavale.",
  "settings.general.row.sidebarSessions.always": "Kuva alati",
