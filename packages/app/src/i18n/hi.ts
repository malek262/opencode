export const dict = {
  ...
  "sidebar.settled": "निपटाए गए",
  "sidebar.settle": "थ्रेड निपटाएँ",
  "sidebar.unsettle": "थ्रेड पुनः सक्रिय करें",
  "sidebar.thread.new": "नया थ्रेड",
  "sidebar.thread.pin": "थ्रेड पिन करें",
  "sidebar.thread.unpin": "पिन हटाएँ",
  "sidebar.status.working": "कार्य में",
  "sidebar.status.done": "पूर्ण",
  ...
  "settings.general.row.navigation.description": "शीर्षक बार में टैब या स्थायी साइडबार का उपयोग करें",
  "settings.general.row.navigation.tabs": "टैब",
  "settings.general.row.navigation.sidebar": "साइडबार",
  "settings.general.row.sidebarSessions.title": "निष्क्रिय थ्रेड निपटाने की अवधि",
  "settings.general.row.sidebarSessions.description": "निष्क्रिय थ्रेड निपटाए गए में चले जाते हैं। सक्रिय थ्रेड दिखाई देते रहते हैं।",
  "settings.general.row.sidebarSessions.always": "हमेशा दिखाएं",
