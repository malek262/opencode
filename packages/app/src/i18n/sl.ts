export const dict = {
  ...
  "sidebar.unsettle": "Vrni nit",
  "sidebar.thread.new": "Nova nit",
  "sidebar.thread.pin": "Pripni nit",
  "sidebar.thread.unpin": "Odpni nit",
  "sidebar.status.working": "V teku",
  "sidebar.status.done": "Končano",
  "sidebar.status.attention": "Potreben vnos",
  ...
  "settings.general.row.navigation.description": "Uporabite zavihke v naslovni vrstici ali trajno stransko vrstico",
  "settings.general.row.navigation.tabs": "Zavihki",
  "settings.general.row.navigation.sidebar": "Stranska vrstica",
  "settings.general.row.sidebarSessions.title": "Odloži nedejavne niti po",
  "settings.general.row.sidebarSessions.description": "Nedejavne niti se premaknejo med odložene. Dejavne niti ostanejo vidne.",
  "settings.general.row.sidebarSessions.always": "Vedno prikaži",
