export const dict = {
  ...
  "sidebar.settled": "Suljetut",
  "sidebar.settle": "Sulje ketju",
  "sidebar.unsettle": "Palauta ketju",
  "sidebar.thread.new": "Uusi ketju",
  "sidebar.thread.pin": "Kiinnitä ketju",
  ...
  "settings.general.row.navigation.description": "Käytä välilehtiä otsikkopalkissa tai pysyvää sivupalkkia",
  "settings.general.row.navigation.tabs": "Välilehdet",
  "settings.general.row.navigation.sidebar": "Sivupalkki",
  "settings.general.row.sidebarSessions.title": "Sulje joutilaat ketjut ajan jälkeen",
  "settings.general.row.sidebarSessions.description": "Joutilaat ketjut siirtyvät Suljetut-osioon. Käynnissä olevat ketjut pysyvät näkyvissä.",
  "settings.general.row.sidebarSessions.always": "Näytä aina",
