export const dict = {
  ...
  "sidebar.archived.restore": "セッションを復元",
  ...
  "settings.general.row.sidebarSessions.title": "アーカイブするまでのアイドル時間",
  "settings.general.row.sidebarSessions.description": "アーカイブ済みに移動します。作業中のセッションは表示されたままです。",
