export const dict = {
  ...
  "sidebar.settled": "整理済み",
  "sidebar.settle": "スレッドを整理",
  "sidebar.unsettle": "スレッドを復元",
  "sidebar.thread.new": "新しいスレッド",
  "sidebar.thread.pin": "スレッドをピン留め",
  ...
  "settings.general.row.navigation.description": "タイトルバーのタブまたは常時表示のサイドバーを使用します",
  "settings.general.row.navigation.tabs": "タブ",
  "settings.general.row.navigation.sidebar": "サイドバー",
  "settings.general.row.sidebarSessions.title": "無操作のスレッドを整理するまでの期間",
  "settings.general.row.sidebarSessions.description": "無操作のスレッドは整理済みに移動します。作業中のスレッドは表示されたままです。",
  "settings.general.row.sidebarSessions.always": "常に表示",
