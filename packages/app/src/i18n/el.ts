export const dict = {
  ...
  "sidebar.settled": "Τακτοποιημένες",
  "sidebar.settle": "Τακτοποίηση νήματος",
  "sidebar.unsettle": "Επαναφορά νήματος",
  "sidebar.thread.new": "Νέο νήμα",
  "sidebar.thread.pin": "Καρφίτσωμα νήματος",
  ...
  "settings.general.row.navigation.description": "Χρησιμοποιήστε καρτέλες στη γραμμή τίτλου ή μια μόνιμη πλευρική γραμμή",
  "settings.general.row.navigation.tabs": "Καρτέλες",
  "settings.general.row.navigation.sidebar": "Πλευρική γραμμή",
  "settings.general.row.sidebarSessions.title": "Τακτοποίηση αδρανών νημάτων μετά",
  "settings.general.row.sidebarSessions.description": "Τα αδρανή νήματα μεταφέρονται στα τακτοποιημένα. Τα νήματα σε εργασία παραμένουν ορατά.",
  "settings.general.row.sidebarSessions.always": "Να εμφανίζονται πάντα",
