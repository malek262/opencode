export const dict = {
  ...
  "sidebar.settled": "მოწესრიგებული",
  "sidebar.settle": "თემის მოწესრიგება",
  "sidebar.unsettle": "თემის აღდგენა",
  "sidebar.thread.new": "ახალი თემა",
  "sidebar.thread.pin": "თემის მიმაგრება",
  ...
  "settings.general.row.navigation.description": "გამოიყენეთ ჩანართები სათაურის ზოლში ან მუდმივი გვერდითი პანელი",
  "settings.general.row.navigation.tabs": "ჩანართები",
  "settings.general.row.navigation.sidebar": "გვერდითი პანელი",
  "settings.general.row.sidebarSessions.title": "უმოქმედო თემების მოწესრიგების ვადა",
  "settings.general.row.sidebarSessions.description": "უმოქმედო თემები გადადის მოწესრიგებულებში. მომუშავე თემები ხილული რჩება.",
  "settings.general.row.sidebarSessions.always": "ყოველთვის ჩვენება",
