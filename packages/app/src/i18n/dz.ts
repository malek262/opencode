export const dict: Record<string, string> = {
  ...
  "sidebar.settled": "བསྒུབས་ཟིན་པ།",
  "sidebar.settle": "གླེང་མོལ་བསྒྲུབས།",
  "sidebar.unsettle": "གླེང་མོ་སོར་ུད།",
  "sidebar.thread.new": "གླེང་མོལ་གསརཔ།",
  "sidebar.thread.pin": "གླེང་མོལ་བཀག་སྒྲིལ།",
  ...
  "settings.general.row.navigation.description": "མགོ་བརྗོད་ནང་ མཆོང་ལྡེ་ ཡང་ན་ ཟུར་ཕྲེང་ ལག་ལེན་འཐབ།",
  "settings.general.row.navigation.tabs": "མཆོང་ལྡེ།",
  "settings.general.row.navigation.sidebar": "ཟུར་ཕྲེང་།",
  "settings.general.row.sidebarSessions.title": "་ལཱ་བའི་གླེང་མོལ་བསྒྲུབས་ཚེ།",
  "settings.general.row.sidebarSessions.description": "མ་ཱ་བི་གེང་མོལ་བསྒྲུབས་ཟིན་རུ་སོང་། ལཱ་འབད་བཞིན་པ་སྟོན།",
  "settings.general.row.sidebarSessions.always": "ད་ལྟོ་རང་ སྟོན།",
