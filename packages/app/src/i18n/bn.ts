export const dict: Record<string, string> = {
  ...
  "sidebar.settled": "নিষ্পত্তি হওয়া",
  "sidebar.settle": "থ্রেড নিষ্পত্তি করুন",
  "sidebar.unsettle": "থ্রেড পুনরুদ্ধার করুন",
  "sidebar.thread.new": "নতুন থ্রেড",
  "sidebar.thread.pin": "থ্রেড পিন করুন",
  ...
  "settings.general.row.navigation.description": "শিরোনাম বারে ট্যাব বা স্থায়ী সাইডবার ব্যবহার করুন",
  "settings.general.row.navigation.tabs": "ট্যাব",
  "settings.general.row.navigation.sidebar": "সাইডবার",
  "settings.general.row.sidebarSessions.title": "নিষ্ক্রিয় থ্রেড নিষ্পত্তির সময়",
  "settings.general.row.sidebarSessions.description": "নিষ্ক্রিয় থ্রেড নিষ্পত্তি হওয়াতে চলে যায়। কাজ চলমান থ্রেড দৃশ্যমান থাকে।",
  "settings.general.row.sidebarSessions.always": "সবসময় দেখান",
