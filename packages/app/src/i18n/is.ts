...
export const dict = {
  ...
  "sidebar.settled": "Frágengin",
  "sidebar.settle": "Fráganga þráð",
  "sidebar.unsettle": "Enduropna þráð",
  "sidebar.thread.new": "Nýr þráður",
  "sidebar.thread.pin": "Festa þráð",
  ...
  "settings.general.row.navigation.description": "Nota flipa í titilstiku eða varanlega hliðarstiku",
  "settings.general.row.navigation.tabs": "Flipar",
  "settings.general.row.navigation.sidebar": "Hliðarstika",
  "settings.general.row.sidebarSessions.title": "Fráganga óvirkja þræði eftir",
  "settings.general.row.sidebarSessions.description": "Óvirkir þræði fara í frágengin. Virkir þræði haldast sýnilegir.",
  "settings.general.row.sidebarSessions.always": "Sýna alltaf",
