export const dict = {
  ...
  "sidebar.settled": "Tamamlanan",
  "sidebar.settle": "Temany tamamla",
  "sidebar.unsettle": "Temany gaýtadan aç",
  "sidebar.thread.new": "Täze tema",
  "sidebar.thread.pin": "Temany berkit",
  ...
  "settings.general.row.navigation.description": "Sözbaşy zolagynda goýmalar ýa-da hemişelik gapdal panel ulanyň",
  "settings.general.row.navigation.tabs": "Goýmalar",
  "settings.general.row.navigation.sidebar": "Gapdal panel",
  "settings.general.row.sidebarSessions.title": "Işjeň bolmadyk temalary tamamlama möhleti",
  "settings.general.row.sidebarSessions.description": "Işjeň bolmadyk temalar tamamlananlara geçýär. Işleýän temalar görünýär.",
  "settings.general.row.sidebarSessions.always": "Elmydama görkez",
