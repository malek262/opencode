export const dict: Record<string, string> = {
  ...
  "sidebar.archived.restore": "সেশন পুনরুদ্ধার করুন",
  ...
  "settings.general.row.sidebarSessions.title": "নিষ্ক্রিয় সেশন আর্কাইভ করুন",
  "settings.general.row.sidebarSessions.description": "নিষ্ক্রিয় সেশন আর্কাইভ করাতে চলে যায়। কর্মরত সেশন দৃশ্যমান থাকে।",
