export const dict = {
  ...
  "sidebar.settled": "Selesai",
  "sidebar.settle": "Selesaikan bebenang",
  "sidebar.unsettle": "Pulihkan bebenang",
  "sidebar.thread.new": "Bebenang baharu",
  "sidebar.thread.pin": "Sematkan bebenang",
  ...
  "settings.general.row.navigation.description": "Guna tab pada bar tajuk atau bar sisi kekal",
  "settings.general.row.navigation.tabs": "Tab",
  "settings.general.row.navigation.sidebar": "Bar sisi",
  "settings.general.row.sidebarSessions.title": "Selesaikan bebenang terbiar selepas",
  "settings.general.row.sidebarSessions.description": "Bebenang terbiar berpindah ke Selesai. Bebenang yang bekerja kekal kelihatan.",
  "settings.general.row.sidebarSessions.always": "Sentiasa tunjuk",
