export const dict = {
  ...
  "sidebar.archived.restore": "Restaurer la session",
  ...
  "settings.general.row.sidebarSessions.title": "Archiver les sessions inactives après",
  "settings.general.row.sidebarSessions.description": "Les sessions inactives passent dans Archivées. Les sessions actives restent visibles.",
