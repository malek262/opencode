export const dict = {
  ...
  "sidebar.archived": "Αρχειοθετημένες",
  "sidebar.archived.restore": "Επαναφορά συνεδρίας",
  ...
  "settings.general.row.sidebarSessions.title": "Αρχειοθέτηση αδρανών συνεδριών μετά από",
  "settings.general.row.sidebarSessions.description": "Οι αδρανείς συνεδρίες μετακινούνται στις Αρχειοθετημένες. Οι ενεργές συνεδρίες παραμένουν ορατές.",
