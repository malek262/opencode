export const dict = {
  ...
  "sidebar.archived": "Arkiverad",
  "sidebar.archived.restore": "Återställ session",
  ...
  "settings.general.row.sidebarSessions.title": "Arkivera inaktiva sessioner efter",
  "settings.general.row.sidebarSessions.description": "Inaktiva sessioner flyttas till Arkiverad. Aktiva sessioner förblir synliga.",
