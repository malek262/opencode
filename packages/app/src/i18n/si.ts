export const dict: Record<string, string> = {
  ...
  "sidebar.settled": "නිශ්චල කළ",
  "sidebar.settle": "සාකච්ඡාව නිශ්චල කරන්න",
  "sidebar.unsettle": "සාකච්ඡාව යළි සක්‍රිය කරන්න",
  "sidebar.thread.new": "නව සාකච්ඡාව",
  "sidebar.thread.pin": "සාකච්ඡාව අමුණන්න",
  ...
  "settings.general.row.navigation.description": "මාතෘකා තීරුවේ ටැබ් හෝ ස්ථිර පැති තීරුව භාවිත කරන්න",
  "settings.general.row.navigation.tabs": "ටැබ්",
  "settings.general.row.navigation.sidebar": "පැති තීරුව",
  "settings.general.row.sidebarSessions.title": "අක්‍රිය සාකච්ඡා නිශ්චල කිරීමේ කාලය",
  "settings.general.row.sidebarSessions.description": "අක්‍රිය සාකච්ඡා නිශ්චල කළ ඒවාට යයි. ක්‍රියාත්මක සාකච්ඡා දිස්වේ.",
  "settings.general.row.sidebarSessions.always": "සැමවිටම පෙන්වන්න",
