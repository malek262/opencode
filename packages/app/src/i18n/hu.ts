...
export const dict = {
  ...
  "sidebar.settled": "Lezárt",
  "sidebar.settle": "Szál lezárása",
  "sidebar.unsettle": "Szál visszaállítása",
  "sidebar.thread.new": "Új szál",
  "sidebar.thread.pin": "Szál rögzítése",
  ...
  "settings.general.row.navigation.description": "Lapok a címsorban vagy rögzített oldalsáv",
  "settings.general.row.navigation.tabs": "Lapok",
  "settings.general.row.navigation.sidebar": "Oldalsáv",
  "settings.general.row.sidebarSessions.title": "Tétlen szálak lezárása ennyi idő után",
  "settings.general.row.sidebarSessions.description": "A tétlen szálak a lezártak közé kerülnek. A dolgozó szálak láthatók maradnak.",
  "settings.general.row.sidebarSessions.always": "Mindig látszódjon",
