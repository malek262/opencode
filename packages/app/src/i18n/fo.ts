export const dict = {
  ...
  "sidebar.settled": "Avgreidd",
  "sidebar.settle": "Avgreið tráð",
  "sidebar.unsettle": "Enduropna tráð",
  "sidebar.thread.new": "Nýggjur tráður",
  "sidebar.thread.pin": "Festa tráð",
  "sidebar.thread.unpin": "Losa tráð",
  "sidebar.status.working": "Arbeiðir",
  "sidebar.status.done": "Liðugt",
  "sidebar.status.attention": "Krevur inndata",
  ...
  "settings.general.row.navigation.description": "Brúka flipar í heitinum ella eitt fast síðupanel",
  "settings.general.row.navigation.tabs": "Flipar",
  "settings.general.row.navigation.sidebar": "Síðupanel",
  "settings.general.row.sidebarSessions.title": "Avgreið óvirknar tráðir eftir",
  "settings.general.row.sidebarSessions.description": "Óvirknir tráðir fara í avgreidd. Virknir tráðir haldast sjónligir.",
  "settings.general.row.sidebarSessions.always": "Vís altíð",
