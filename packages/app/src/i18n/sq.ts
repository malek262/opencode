export const dict = {
  ...
  "sidebar.archived": "Arkivuar",
  "sidebar.archived.restore": "Rikthe sesionin",
  ...
  "settings.general.row.sidebarSessions.title": "Arkivo sesionet joaktive pas",
  "settings.general.row.sidebarSessions.description": "Sesionet joaktive kalojnë te Arkivuar. Sesionet aktive mbeten të dukshme.",
