export const dict = {
  ...
  "sidebar.archived": "Արխիվացված",
  "sidebar.archived.restore": "Վերականգնել նիստը",
  ...
  "settings.general.row.sidebarSessions.title": "Արխիվացնել անգործուն նիստերը՝",
  "settings.general.row.sidebarSessions.description": "Անգործուն նիստերը տեղափոխվում են Արխիվացված։ Աշխատող նիստերը մնում են տեսանելի։",
