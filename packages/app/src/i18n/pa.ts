export const dict = {
  ...
  "sidebar.settled": "ਨਿਪਟਾਏ ਗਏ",
  "sidebar.settle": "ਥਰੈਡ ਨਿਪਟਾਓ",
  "sidebar.unsettle": "ਥਰੈਡ ਬਹਾਲ ਕਰੋ",
  "sidebar.thread.new": "ਨਵਾਂ ਥਰੈਡ",
  "sidebar.thread.pin": "ਥਰੈਡ ਪਿੰਨ ਕਰੋ",
  ...
  "settings.general.row.navigation.description": "ਟਾਈਟਲ ਬਾਰ ਵਿੱਚ ਟੈਬਾਂ ਜਾਂ ਸਥਾਈ ਸਾਈਡਬਾਰ ਵਰਤੋ",
  "settings.general.row.navigation.tabs": "ਟੈਬਾਂ",
  "settings.general.row.navigation.sidebar": "ਸਾਈਡਬਾਰ",
  "settings.general.row.sidebarSessions.title": "ਬੇਕਾਰ ਥਰੈਡ ਨਿਪਟਾਉਣ ਦਾ ਸਮਾਂ",
  "settings.general.row.sidebarSessions.description": "ਬੇਕਾਰ ਥਰੈਡ ਨਿਪਟਾਏ ਗਏ ਵਿੱਚ ਚਲੇ ਜਾਂਦੇ ਹਨ। ਕੰਮ ਕਰਦੇ ਥਰੈਡ ਦਿਖਦੇ ਰਹਿੰਦੇ ਹਨ।",
  "settings.general.row.sidebarSessions.always": "ਹਮੇਸ਼ਾ ਦਿਖਾਓ",
