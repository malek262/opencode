export const dict = {
  ...
  "sidebar.settled": "Diselesaikan",
  "sidebar.settle": "Selesaikan thread",
  "sidebar.unsettle": "Pulihkan thread",
  "sidebar.thread.new": "Thread baru",
  "sidebar.thread.pin": "Sematkan thread",
  ...
  "settings.general.row.sidebarSessions.title": "Selesaikan thread menganggur setelah",
  "settings.general.row.sidebarSessions.description": "Thread menganggur pindah ke Diselesaikan. Thread yang bekerja tetap terlihat.",
