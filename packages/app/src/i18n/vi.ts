export const dict = {
  ...
  "sidebar.archived.restore": "Khôi phục phiên",
  ...
  "settings.general.row.sidebarSessions.title": "Lưu trữ phiên không hoạt động sau",
  "settings.general.row.sidebarSessions.description": "Phiên không hoạt động sẽ chuyển vào Đã lưu trữ. Phiên đang chạy vẫn hiển thị.",
