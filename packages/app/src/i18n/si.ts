export const dict: Record<string, string> = {
  ...
  "sidebar.archived": "සංරක්ෂිත",
  "sidebar.archived.restore": "සැසිය යළි පිහිටුවන්න",
  ...
  "settings.general.row.sidebarSessions.title": "නිෂ්ක්‍රීය සැසි සංරක්ෂණය කරන්න",
  "settings.general.row.sidebarSessions.description": "නිෂ්ක්‍රීය සැසි සංරක්ෂිත වෙත යයි. ක්‍රියාත්මක සැසි දිස්වේ.",
