export const dict = {
  ...
  "sidebar.settled": "Afgerond",
  "sidebar.settle": "Thread afronden",
  "sidebar.unsettle": "Thread herstellen",
  "sidebar.thread.new": "Nieuwe thread",
  "sidebar.thread.pin": "Thread vastmaken",
  ...
  "settings.general.row.navigation.description": "Gebruik tabbladen in de titelbalk of een vaste zijbalk",
  "settings.general.row.navigation.tabs": "Tabbladen",
  "settings.general.row.navigation.sidebar": "Zijbalk",
  "settings.general.row.sidebarSessions.title": "Inactieve threads afronden na",
  "settings.general.row.sidebarSessions.description": "Inactieve threads gaan naar Afgerond. Actieve threads blijven zichtbaar.",
  "settings.general.row.sidebarSessions.always": "Altijd tonen",
