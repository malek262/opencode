...
export const dict = {
  ...
  "sidebar.archived": "Archiválva",
  "sidebar.archived.restore": "Munkamenet visszaállítása",
  ...
  "settings.general.row.sidebarSessions.title": "Inaktív munkamenetek archiválása ennyi idő után",
  "settings.general.row.sidebarSessions.description": "Az inaktív munkamenetek az Archiválva részbe kerülnek. A futó munkamenetek láthatók maradnak.",
