export const dict = {
  ...
  "sidebar.settled": "Yakunlangan",
  "sidebar.settle": "Trevni yakunlash",
  "sidebar.unsettle": "Trevni qayta ochish",
  "sidebar.thread.new": "Yangi trev",
  "sidebar.thread.pin": "Trevni mahkamlash",
  "sidebar.thread.unpin": "Mahkamlashni bekor qilish",
  "sidebar.status.working": "Ishlamoqda",
  "sidebar.status.done": "Tayyor",
  "sidebar.status.attention": "Kiritish kerak",
  ...
  "settings.general.row.navigation.description": "Sarlavha panelida tablardan yoki doimiy yon paneldan foydalaning",
  "settings.general.row.navigation.tabs": "Tablar",
  "settings.general.row.navigation.sidebar": "Yon panel",
  "settings.general.row.sidebarSessions.title": "Bo'sh trevlarni yakunlash muddati",
  "settings.general.row.sidebarSessions.description": "Bo'sh trevlar yakunlanganlarga ko'chadi. Ishlayotgan trevlar ko'rinib turadi.",
  "settings.general.row.sidebarSessions.always": "Har doim ko'rsatish",
