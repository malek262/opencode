export const dict = {
  ...
  "sidebar.settled": "طے شدہ",
  "sidebar.settle": "تھریڈ طے کریں",
  "sidebar.unsettle": "تھریڈ بحال کریں",
  "sidebar.thread.new": "نیا تھریڈ",
  "sidebar.thread.pin": "تھریڈ پن کریں",
  ...
  "settings.general.row.navigation.description": "ٹائٹل بار میں ٹیبز یا مستقل سائیڈ بار استعمال کریں",
  "settings.general.row.navigation.tabs": "ٹیبز",
  "settings.general.row.navigation.sidebar": "سائیڈ بار",
  "settings.general.row.sidebarSessions.title": "غیر فعال تھریڈز طے کرنے کی مدت",
  "settings.general.row.sidebarSessions.description": "غیر فعال تھریڈز طے شدہ میں چلے جاتے ہیں۔ کام کرتے تھریڈز نظر آتے رہتے ہیں۔",
  "settings.general.row.sidebarSessions.always": "ہمیشہ دکھائیں",
