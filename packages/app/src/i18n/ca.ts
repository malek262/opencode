export const dict = {
  ...
  "sidebar.settled": "Tancats",
  "sidebar.settle": "Tanca el fil",
  "sidebar.unsettle": "Reobre el fil",
  "sidebar.thread.new": "Fil nou",
  "sidebar.thread.pin": "Fixa el fil",
  ...
  "settings.general.row.navigation.description": "Usa pestanyes a la barra de títol o una barra lateral persistent",
  "settings.general.row.navigation.tabs": "Pestanyes",
  "settings.general.row.navigation.sidebar": "Barra lateral",
  "settings.general.row.sidebarSessions.title": "Tanca els fils inactius després de",
  "settings.general.row.sidebarSessions.description": "Els fils inactius passen a Tancats. Els fils actius continuen visibles.",
