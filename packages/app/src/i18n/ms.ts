export const dict = {
  ...
  "settings.general.row.sidebarSessions.title": "Arkibkan sesi tidak aktif selepas",
  "settings.general.row.sidebarSessions.description": "Sesi tidak aktif dialihkan ke Diarkibkan. Sesi sedang berjalan kekal kelihatan.",
