export const dict = {
  ...
  "sidebar.settled": "အနားယူထားသည်",
  "sidebar.settle": "ဆွေးနွေးမှုကို အနားယူစေ",
  "sidebar.unsettle": "အနားယူခြင်းကို ပယ်ဖျက်",
  "sidebar.thread.new": "ဆွေးနွေးမှုအသစ်",
  "sidebar.thread.pin": "ဆွေးနွေးမှုကို ပင်ထိုး",
  ...
  "settings.general.row.navigation.description": "ခေါင်းစီးတန်းတွင် တဘ်များ သို့မဟုတ် အမြဲတမ်း ဘေးတန်း သုံးပါ",
  "settings.general.row.navigation.tabs": "တဘ်များ",
  "settings.general.row.navigation.sidebar": "ဘေးတန်း",
  "settings.general.row.sidebarSessions.title": "အသုံးမပြုသော ဆွေးနွေးမှုများ အနားယူစေရန် အချိန်",
  "settings.general.row.sidebarSessions.description": "အသုံးမပြုသော ဆွေးနွေးမှုများသည် အနားယူထားသည်ထဲသို့ ရွှေ့မည်။ လုပ်ဆောင်နေသော ဆွေးနွေးမှုများ ဆက်ပြနေမည်။",
  "settings.general.row.sidebarSessions.always": "အမြဲပြသ",
