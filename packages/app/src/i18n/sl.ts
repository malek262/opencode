export const dict = {
  ...
  "sidebar.archived.restore": "Obnovi sejo",
  ...
  "settings.general.row.sidebarSessions.title": "Arhiviraj nedejavne seje po",
  "settings.general.row.sidebarSessions.description": "Nedejavne seje se premaknejo v Arhivirano. Dejavnе seje ostanejo vidne.",
