export const dict = {
  ...
  "sidebar.settled": "Avslutade",
  "sidebar.settle": "Avsluta tråd",
  "sidebar.unsettle": "Återaktivera tråd",
  "sidebar.thread.new": "Ny tråd",
  "sidebar.thread.pin": "Fäst tråd",
  ...
  "settings.general.row.navigation.description": "Använd flikar i namnlisten eller ett fast sidofält",
  "settings.general.row.navigation.tabs": "Flikar",
  "settings.general.row.navigation.sidebar": "Sidofält",
  "settings.general.row.sidebarSessions.title": "Avsluta inaktiva trådar efter",
  "settings.general.row.sidebarSessions.description": "Inaktiva trådar flyttas till Avslutade. Aktiva trådar förblir synliga.",
  "settings.general.row.sidebarSessions.always": "Visa alltid",
