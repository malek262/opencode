...
export const dict = {
  ...
  "sidebar.archived.restore": "Sitzung wiederherstellen",
  ...
  "settings.general.row.sidebarSessions.title": "Inaktive Sitzungen archivieren nach",
  "settings.general.row.sidebarSessions.description": "Inaktive Sitzungen werden nach „Archiviert“ verschoben. Aktive Sitzungen bleiben sichtbar.",
