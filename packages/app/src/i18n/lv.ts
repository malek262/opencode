export const dict = {
  ...
  "sidebar.settled": "Nokārtotās",
  "sidebar.settle": "Nokārtot pavedienu",
  "sidebar.unsettle": "Atjaunot pavedienu",
  "sidebar.thread.new": "Jauns pavediens",
  "sidebar.thread.pin": "Piespraust pavedienu",
  ...
  "settings.general.row.navigation.description": "Izmantot cilnes virsraksta joslā vai pastāvīgu sānjoslu",
  "settings.general.row.navigation.tabs": "Cilnes",
  "settings.general.row.navigation.sidebar": "Sānjosla",
  "settings.general.row.sidebarSessions.title": "Nokārtot neaktīvos pavedienus pēc",
  "settings.general.row.sidebarSessions.description": "Neaktīvie pavedieni pāriet uz nokārtotajiem. Strādājošie pavedieni paliek redzami.",
  "settings.general.row.sidebarSessions.always": "Rādīt vienmēr",
