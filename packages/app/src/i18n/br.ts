export const dict = {
  ...
  "sidebar.archived": "Archiuet",
  "sidebar.archived.restore": "Adsevel ar sesion",
  ...
  "settings.general.row.sidebarSessions.title": "Arc'hivañ ar sesionoù diseblant goude",
  "settings.general.row.sidebarSessions.description": "Ar sesionoù diseblant a ya d'an arquiv. Ar sesionoù oberiant a chom gwelet.",
