...
export const dict = {
  ...
  "sidebar.archived": "Geymt",
  "sidebar.archived.restore": "Endurheimta setu",
  ...
  "settings.general.row.sidebarSessions.title": "Geyma óvirkar setur eftir",
  "settings.general.row.sidebarSessions.description": "Óvirkar setur færast í Geymt. Virkar setur haldast sýnilegar.",
