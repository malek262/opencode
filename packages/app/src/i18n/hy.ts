export const dict = {
  ...
  "sidebar.settled": "Կարգավորված",
  "sidebar.settle": "Թելը կարգավորել",
  "sidebar.unsettle": "Թելը վերականգնել",
  "sidebar.thread.new": "Նոր թել",
  "sidebar.thread.pin": "Թելը գամել",
  ...
  "settings.general.row.navigation.description": "Օգտագործեք ներդիրներ վերնագրի տողում կամ մշտական կողային վահանակ",
  "settings.general.row.navigation.tabs": "Ներդիրներ",
  "settings.general.row.navigation.sidebar": "Կողային վահանակ",
  "settings.general.row.sidebarSessions.title": "Ոչ ակտիվ թելերը կարգավորելու ժամկետ",
  "settings.general.row.sidebarSessions.description": "Ոչ ակտիվ թելերը տեղափոխվում են կարգավորվածներ։ Աշխատող թելերը մնում են տեսանելի։",
  "settings.general.row.sidebarSessions.always": "Միշտ ցուցադրել",
