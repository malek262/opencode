export const dict = {
  ...
  "sidebar.settled": "Одложени",
  "sidebar.settle": "Одложи нишка",
  "sidebar.unsettle": "Врати нишка",
  "sidebar.thread.new": "Нова нишка",
  "sidebar.thread.pin": "Прикачи нишка",
  "sidebar.thread.unpin": "Откачи нишка",
  "sidebar.status.working": "Во тек",
  "sidebar.status.done": "Готово",
  "sidebar.status.attention": "Потребен е внес",
  ...
  "settings.general.row.navigation.description": "Користете картички во насловната лента или постојана странична лента",
  "settings.general.row.navigation.tabs": "Картички",
  "settings.general.row.navigation.sidebar": "Странична лента",
  "settings.general.row.sidebarSessions.title": "Одложи неактивни нишки по",
  "settings.general.row.sidebarSessions.description": "Неактивните нишки преминуваат во одложени. Активните нишки остануваат видливи.",
  "settings.general.row.sidebarSessions.always": "Секогаш прикажувај",
