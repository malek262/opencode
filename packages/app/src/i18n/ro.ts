export const dict = {
  ...
  "sidebar.settled": "Încheiate",
  "sidebar.settle": "Încheie firul",
  "sidebar.unsettle": "Redeschide firul",
  "sidebar.thread.new": "Fir nou",
  "sidebar.thread.pin": "Fixează firul",
  "sidebar.thread.unpin": "Anulează fixarea",
  "sidebar.status.working": "Lucrează",
  "sidebar.status.done": "Gata",
  "sidebar.status.attention": "Necesită introducere",
  ...
  "settings.general.row.navigation.description": "Folosește file în bara de titlu sau o bară laterală permanentă",
  "settings.general.row.navigation.tabs": "File",
  "settings.general.row.navigation.sidebar": "Bară laterală",
  "settings.general.row.sidebarSessions.title": "Încheie firele inactive după",
  "settings.general.row.sidebarSessions.description": "Firele inactive trec la încheiate. Firele active rămân vizibile.",
  "settings.general.row.sidebarSessions.always": "Afișează mereu",
