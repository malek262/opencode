export const dict = {
  ...
  "sidebar.archived.restore": "Przywróć sesję",
  ...
  "settings.general.row.sidebarSessions.title": "Archiwizuj bezczynne sesje po",
  "settings.general.row.sidebarSessions.description": "Bezczynne sesje trafiają do Zarchiwizowane. Aktywne sesje pozostają widoczne.",
