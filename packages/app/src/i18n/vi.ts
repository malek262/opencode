export const dict = {
  ...
  "sidebar.settled": "Đã xếp",
  "sidebar.settle": "Xếp chuỗi",
  "sidebar.unsettle": "Khôi phục chuỗi",
  "sidebar.thread.new": "Chuỗi mới",
  "sidebar.thread.pin": "Ghim chuỗi",
  ...
  "settings.general.row.navigation.description": "Dùng thẻ trên thanh tiêu đề hoặc thanh bên cố định",
  "settings.general.row.navigation.tabs": "Thẻ",
  "settings.general.row.navigation.sidebar": "Thanh bên",
  "settings.general.row.sidebarSessions.title": "Xếp các chuỗi nhàn rỗi sau",
  "settings.general.row.sidebarSessions.description": "Các chuỗi nhàn rỗi chuyển sang Đã xếp. Các chuỗi đang làm vẫn hiển thị.",
  "settings.general.row.sidebarSessions.always": "Luôn hiển thị",
