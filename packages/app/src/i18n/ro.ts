export const dict = {
  ...
  "sidebar.archived.restore": "Restaurează sesiunea",
  ...
  "settings.general.row.sidebarSessions.title": "Arhivează sesiunile inactive după",
  "settings.general.row.sidebarSessions.description": "Sesiunile inactive trec în Arhivate. Sesiunile active rămân vizibile.",
