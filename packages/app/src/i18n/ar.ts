export const dict = {
  ...
  "sidebar.archived": "المؤرشفة",
  "sidebar.archived.restore": "استعادة الجلسة",
  ...
  "settings.general.row.sidebarSessions.title": "أرشفة الجلسات الخاملة بعد",
  "settings.general.row.sidebarSessions.description": "تنتقل الجلسات الخاملة إلى المؤرشفة. تبقى الجلسات النشطة ظاهرة.",
