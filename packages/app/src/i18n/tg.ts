export const dict = {
  ...
  "sidebar.settled": "Анҷомёфта",
  "sidebar.settle": "Риштаро анҷом додан",
  "sidebar.unsettle": "Риштаро барқарор кардан",
  "sidebar.thread.new": "Риштаи нав",
  "sidebar.thread.pin": "Риштаро маҳкам кардан",
  ...
  "settings.general.row.navigation.description": "Дар сарлавҳа варақаҳо ё панели паҳлуии доимӣ истифода баред",
  "settings.general.row.navigation.tabs": "Варақаҳо",
  "settings.general.row.navigation.sidebar": "Панели паҳлуӣ",
  "settings.general.row.sidebarSessions.title": "Риштаҳои ғайрифаъолро анҷом додан пас аз",
  "settings.general.row.sidebarSessions.description": "Риштаҳои ғайрифаъол ба анҷомёфта мегузаранд. Риштаҳои корӣ намоён мемонанд.",
  "settings.general.row.sidebarSessions.always": "Ҳамеша нишон додан",
