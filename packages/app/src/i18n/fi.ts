export const dict = {
  ...
  "sidebar.archived": "Arkistoitu",
  "sidebar.archived.restore": "Palauta istunto",
  ...
  "settings.general.row.sidebarSessions.title": "Arkistoi käyttämättömät istunnot, kun",
  "settings.general.row.sidebarSessions.description": "Käyttämättömät istunnot siirtyvät kohtaan Arkistoitu. Aktiiviset istunnot pysyvät näkyvissä.",
