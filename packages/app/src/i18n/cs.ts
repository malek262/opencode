export const dict = {
  ...
  "sidebar.settle": "Odložit vlákno",
  "sidebar.unsettle": "Vrátit vlákno",
  "sidebar.thread.new": "Nové vlákno",
  "sidebar.thread.pin": "Připnout vlákno",
  ...
  "settings.general.row.navigation.description": "Použijte karty na titulním panelu nebo trvalý postranní panel",
  "settings.general.row.navigation.tabs": "Karty",
  "settings.general.row.navigation.sidebar": "Postranní panel",
  "settings.general.row.sidebarSessions.title": "Odložit nečinná vlákna po",
  "settings.general.row.sidebarSessions.description": "Nečinná vlákna se přesunou do Odložené. Pracující vlákna zůstanou viditelná.",
  "settings.general.row.sidebarSessions.always": "Vždy zobrazit",
